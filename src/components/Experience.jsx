...
import * as THREE from "three"; // Importing THREE here
import { framerMotionConfig } from "../config";
import { Avatar } from "./Avatar";
import { Office } from "./Office";
import { useScroll } from "@react-three/drei"; // Make sure you import useScroll from the correct library
...
export const Experience = (props) => {
  ...
  return (
    <>
      ...
      <motion.group
        ref={characterGroup}
        // position={[1.844926687862798, 0.2673, 2.460336104598427]}
